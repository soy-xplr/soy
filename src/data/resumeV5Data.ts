// ─────────────────────────────────────────────────────────────
// 국문 이력서 v5 (핵심만 압축한 서구식 포맷)
// 본문 안의 **텍스트**는 굵게 표시됩니다. 정량 성과·핵심 결과에만 사용합니다.
// ─────────────────────────────────────────────────────────────
...
export const resumeV5Data: WesternResumeData = {
  profile: {
    ...
    summary: [
      ...
      "MAU 170만 글로벌 UGC 플랫폼, 150만 MAU 모바일 앱, 누적 회원 40만 교육 서비스를 경험했으며, 사용자 데이터와 운영 문제를 UX·정책·제품 개선으로 연결해 왔습니다.",
    ],
    capabilities: [],
  },
