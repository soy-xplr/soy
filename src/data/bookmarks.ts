...
export const bookmarks: Bookmark[] = [
  ...
  },
  {
    ...
    title: "메이플스토리 월드 플랫폼 구축 및 글로벌 확장",
    url: "https://maplestoryworlds.nexon.com",
    description: "누적 이용자 700만 명 UGC 플랫폼의 검색·정책·글로벌 운영 체계를 기획",
    note: "컨셉 단계부터 국내 소프트 런칭, 글로벌 확장, 운영 성숙화까지 웹·플랫폼 기획에 참여했습니다.",
    category: "웹/플랫폼",
    tags: ["UGC플랫폼", "글로벌", "운영정책"],
